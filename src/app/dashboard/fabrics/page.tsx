...
export default function InwardPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg border border-border shadow-sm overflow-hidden min-h-[400px]">
                {/* ... table ... */}
                            ...
                            {loading ? (
                                ...
                                inwards.map((inward, idx) => (
                                    <tr key={inward._id} className="hover:bg-secondary/5 transition-colors group">
                                        <td className="px-10 py-4 text-xs font-bold text-muted">{idx + 1}</td>
